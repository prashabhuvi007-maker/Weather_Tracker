...
- Save weather data in SQLite database
- Visualize temperature trends using matplotlib
- Automated daily updates using Windows Task Scheduler
...
Show humidity and weather description charts
Create an interactive dashboard using Streamlit
Add email notifications for extreme weather conditions


#Skills Demonstrated

Python programming (API requests, data handling, plotting)
